...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Snark', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个网安菜狗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.snark.top', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/emyia2001', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,telegram,messenge', // 分享的服務，按顺序显示,逗号隔开
